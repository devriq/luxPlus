  ...
  getMovieList: () => {
    return [
      ...
      },
      {
        nome: 'Pânico 4',
        poster:
          'https://c1.staticflickr.com/6/5718/21091934512_dca7dc00c0_o.jpg',
        status: false
      },
      {
        nome: 'O Segredo da Cabana',
        poster:
          'https://cdn.fstatic.com/media/movies/covers/2018/12/1_8WHzWl3.jpg',
        status: false
      },
      {
      ...
      },
      {
        nome: 'Regressão',
        poster:
          'https://br.web.img3.acsta.net/pictures/15/08/17/13/00/015882.jpg',
        status: true
      },
      {
        nome: 'Réfem do Medo',
      ...
      },
      {
        ...
        poster:
          'https://br.web.img3.acsta.net/pictures/17/01/06/12/20/534187.jpg',
        status: false
      },
      {
        nome: 'Corra',
      ...
      },
      {
        nome: 'A Escuridão',
        poster:
          'https://m.media-amazon.com/images/M/MV5BMjIxMTg2NjAyMV5BMl5BanBnXkFtZTgwNDE5ODIxODE@._V1_.jpg',
        status: true
      },
      {
        nome: 'A Cura',
      ...
      },
      {
        nome: 'Cargo',
        poster:
          'https://br.web.img3.acsta.net/pictures/17/10/23/12/33/0246129.jpg',
        status: true
      },
      {
        nome: 'Ao Cair da Noite',
        poster:
          'https://diamondfilms.com/img/poster/5935a58d485ca1bc54ba38fcd.jpg',
        status: true
      },
      {
        nome: 'Hereditário',
      ...
      },
      {
        ...
        poster:
          'https://br.web.img3.acsta.net/pictures/17/12/29/12/41/2418041.jpg',
        status: true
      },
      {
        nome: 'Nós',
      ...
      },
      {
        ...
        poster:
          'https://br.web.img3.acsta.net/pictures/19/06/21/19/47/4841614.jpg',
        status: true
      },
      {
      ...
      },
      {
        ...
        poster:
          'https://br.web.img3.acsta.net/pictures/20/05/22/09/24/4394782.jpg',
        status: true
      },
      {
